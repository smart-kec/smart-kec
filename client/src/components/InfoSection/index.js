            ...
            <InfoRow imgStart={homeObjOne.imgStart}> 
                <Column1>
                    <TextWrapper>
                        ...
                        <BtnWrap>
                            <Button to="home" smooth={true} duration={500} spy={true} exact={true} offset={-80} primary={homeObjOne.primary ? 1 : 0} dark={homeObjOne.dark ? 1 : 0} dark2={homeObjOne.dark2 ? 1 : 0}>{homeObjOne.buttonLabel}</Button>
                        </BtnWrap> 
                    </TextWrapper>
                </Column1>
                <Column2>
